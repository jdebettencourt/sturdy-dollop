...
int main() {
   ...
   while ( a < 101 ){
   mag = magicu(a);
   printf("u divisor = %d M = %08x s = %d ", a, mag.M, mag.s);
   mag = magicu2(a);
   printf("u2 divisor = %d M = %08x s = %d\n", a, mag.M, mag.s);
   a++;
   };

/* following are check calculations for both magicu and magicu2
   mag = magicu(3);
   ...
   if (mag.M + mag.a + mag.s != 0xa330fe27 + 0 + 16) return  3;

   mag = magicu(0x80000001);
   printf("d = %08x, M = %08x a = %d s = %d\n", 0x80000001, mag.M, mag.a, mag.s);
   if (mag.M + mag.a + mag.s != 0xffffffff + 0 + 31) return 4;

   mag = magicu(0xffffffff);
   printf("d = %08x, M = %08x a = %d s = %d\n", 0xffffffff, mag.M, mag.a, mag.s);
   if (mag.M + mag.a + mag.s != 0x80000001 + 0 + 31) return 5;
   ...
   mag = magicu2(102807);
   printf("d = %08x, M = %08x a = %d s = %d\n", 102807, mag.M, mag.a, mag.s);
   if (mag.M + mag.a + mag.s != 0x4661fc4d + 1 + 17) return 13;

   mag = magicu2(0x80000001);
   printf("d = %08x, M = %08x a = %d s = %d\n", 0x80000001, mag.M, mag.a, mag.s);
   if (mag.M + mag.a + mag.s != 0xffffffff + 0 + 31) return 14;

   mag = magicu2(0xffffffff);
   printf("d = %08x, M = %08x a = %d s = %d\n", 0xffffffff, mag.M, mag.a, mag.s);
   if (mag.M + mag.a + mag.s != 0x80000001 + 0 + 31) return 15;
*/
   return 0;
}
